...
class SearchFilters {
  ...
  init(instance: SearchFilters? = nil) {
    if instance != nil {
      self.copyStateFrom(instance!)
    }
  }
  
  func copyStateFrom(instance: SearchFilters) {
  ...
  class var instance: SearchFilters {
  struct Static {
    static let instance: SearchFilters = SearchFilters()
    }
